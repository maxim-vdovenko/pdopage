...
pdoPage.Reached_1 = false;
pdoPage.Reached_2 = false;
pdoPage.Reached_3 = false;
    ...
    switch (config['mode']) {
        ...
        case 'button':
            ...
            if (config['mode'] == 'button') {
                ...
                var $window = $(window);
                var idCont = wrapper.selector;

                $(idCont).on('scroll', function(){
                   
                    if($(this).attr('reached') == 1) {
                      
                        if(!pdoPage.Reached_1) {
                            pdoPage.Reached_1 = true;
                            pdoPage.addPage(config);
                        }
                    }
                    if($(this).attr('reached') == 2) {
                      
                        if(!pdoPage.Reached_2) {
                            pdoPage.Reached_2 = true;
                            pdoPage.addPage(config);
                        }
                    }
                    if($(this).attr('reached') == 3) {
                      
                        if(!pdoPage.Reached_3) {
                            pdoPage.Reached_3 = true;
                            pdoPage.addPage(config);
                        }
                    }
                });
